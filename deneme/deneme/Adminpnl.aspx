...
&nbsp;&nbsp; İhale Ekleme Paneli</div>
    <asp:Panel ID="blogekle" runat="server" CssClass="paneller">
        ...
        <tr>
            <td class="auto-style2" style="text-align: center; font-family: 'Trajan Pro'; font-size: 16px">İhale Başlık</td>
            <td>
                <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style2" style="text-align: center; font-family: 'Trajan Pro'; font-size: 16px">İhale İçerik</td>
            <td>
                <asp:TextBox ID="TextBox2" runat="server" Height="66px" TextMode="MultiLine" Width="400px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style2" style="text-align: center; font-family: 'Trajan Pro'; font-size: 16px">İhale Özet</td>
            <td>
                <asp:TextBox ID="TextBox3" runat="server" Height="66px" TextMode="MultiLine" Width="400px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style3" style="text-align: center; font-family: 'Trajan Pro'; font-size: 16px">İhale Resim</td>
