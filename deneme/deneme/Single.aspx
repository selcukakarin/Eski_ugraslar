<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Single.aspx.cs" Inherits="deneme.single" %>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row fh5co-post-entry single-entry">
            <article class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12 col-xs-offset-0">
                ...
                <span class="fh5co-meta animate-box"><a href="single.aspx">Travel</a></span>
                <h2 class="fh5co-article-title animate-box"><a href="single.aspx">My First Time Traveling in Vietnam</a></h2>
    ...
    <footer id="fh5co-footer">
        <p><small>&copy; 2016. Magazine Free HTML5. All Rights Reserverd.
            <br>
            Designed by <a href="http://freehtml5.co" target="_blank">FREEHTML5.co</a>  Demo Images: <a href="http://unsplash.com/" target="_blank">Unsplash</a></small></p>
    </footer>
